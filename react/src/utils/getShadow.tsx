...
export default function getShadow(theme: { customShadows: { secondary: any; error: any; warning: any; info: any; success: any; primaryButton: any; secondaryButton: any; errorButton: any; warningButton: any; infoButton: any; successButton: any; primary: any; }; }, shadow: any) {
  switch (shadow) {
    case 'secondary':
